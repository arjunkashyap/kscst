...
if($num_rows > 0)
{
	...
	for($i=1;$i<=$num_rows;$i++)
	{
        ...
        echo (intval($snum) >= DIGITIZEDFROM) ? " | <span class=\"link-span clr5 yes-ul\"><a href=\"../Abstract/".$snum."/".$projectid."/index.djvu?djvuopts&amp;page=1&amp;zoom=page\">Abstract</a></span> | <span class=\"link-span clr5 yes-ul\"><a href=\"viewReport.php?snum=".$snum."&amp;projectid=".$projectid."\">Report</a></span>" : "";
        echo "      </p>";
        echo "      <p>";
